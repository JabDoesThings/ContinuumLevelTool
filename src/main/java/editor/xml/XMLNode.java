...
public class XMLNode {
  ...
  public XMLNode(String myName, BufferedReader in) throws IOException {
    ...
    while (in.ready()) {
      ...
      if (c == '<') {
        ...
        if (tag.equals(terminator)) return;
  ...
  public XMLNode getChild(String name) {
    ...
    for (int x = 0; x < children.size(); ++x) {
      ...
      if (xml.name.equals(name)) return xml;
    }
  ...
  public static String readTag(BufferedReader in) throws IOException {
    ...
    while (in.ready()) {
      ...
      if (c == '>') {
        ...
        // comment
        {
          if (lastWord.length() >= 1 && lastWord.charAt(lastWord.length() - 1) == '/')
        ...
        if (name.length() >= 3
            ...
            && fullTag.length() >= 5
            && lastWord.length() >= 2
            && lastWord.substring(lastWord.length() - 2).equals("--")) // end of a comment
        return null;
      }
  ...
  public static void saveNode(XMLNode x, BufferedWriter out, int tabs) throws IOException {
    if (x.children == null) {
      for (int c = 0; c < tabs; ++c) out.write("\t");

      if (x.value != null) out.write(x.value);
      else out.write("null");
      ...
      for (int i = 0; i < x.children.size(); ++i) {
        ...
        if (ch.name != null) out.write("<" + ch.name + ">");
        else out.write("<null>");
  ...
  public static void endLine(BufferedWriter out) throws IOException { // ascii endline... 13,10
    out.write(13);
    out.write(10);
  }

  // PRECONDITION: tag != null
  public static XMLNode getNode(String tag, BufferedReader in) throws IOException {
  ...
  public void print(int tabs) {
    if (children == null) {
      for (int c = 0; c < tabs; ++c) System.out.print("\t");
